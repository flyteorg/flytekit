...
def test_ref():
    ...
    ss = get_serializable(registration_settings, ref_t1)
    ...
    sdk_task = get_serializable(registration_settings, ref_t1)
...
def test_lps(resource_type):
    ...
    sdk_wf = get_serializable(registration_settings, wf1)
