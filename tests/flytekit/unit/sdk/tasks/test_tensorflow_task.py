...
from flytekit.legacy.tasks import tensorflow_task as _tensorflow_task
from flytekit.models import types as _type_models
from flytekit.models.core import identifier as _identifier
from flytekit.legacy.sdk.tasks import inputs, outputs, tensorflow_task
...
def test_simple_tensorflow_task():
    ...
    assert isinstance(simple_tensorflow_task, flytekit.legacy.runnables.SdkRunnableTask)
