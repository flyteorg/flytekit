...
def test_builtin_algorithm_training_job_task():
    ...
    assert builtin_algorithm_training_job_task.interface.inputs["train"].type == _core_types.LiteralType(
...
def test_simple_hpo_job_task():
    ...
    assert simple_xgboost_hpo_job_task.interface.inputs["train"].type == _core_types.LiteralType(
        blob=_core_types.BlobType(
            format="csv",
            dimensionality=_core_types.BlobType.BlobDimensionality.MULTIPART,
        )
    ...
    assert simple_xgboost_hpo_job_task.interface.inputs["validation"].type == _core_types.LiteralType(
        blob=_core_types.BlobType(
            format="csv",
            dimensionality=_core_types.BlobType.BlobDimensionality.MULTIPART,
        )
