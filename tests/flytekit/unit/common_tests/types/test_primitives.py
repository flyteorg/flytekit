...
def test_integer():
    ...
    assert (
        primitives.Integer.to_flyte_literal_type().simple
...
def test_float():
    # Check type specification
    assert (
        primitives.Float.to_flyte_literal_type().simple
        == literal_types.SimpleType.FLOAT
    )
...
def test_boolean():
    # Check type specification
    assert (
        primitives.Boolean.to_flyte_literal_type().simple
        == literal_types.SimpleType.BOOLEAN
    )
...
def test_string():
    # Check type specification
    assert (
        primitives.String.to_flyte_literal_type().simple
        == literal_types.SimpleType.STRING
    )
...
def test_datetime():
    # Check type specification
    assert (
        primitives.Datetime.to_flyte_literal_type().simple
        == literal_types.SimpleType.DATETIME
    )
...
def test_timedelta():
    # Check type specification
    assert (
        primitives.Timedelta.to_flyte_literal_type().simple
        == literal_types.SimpleType.DURATION
    )
...
def test_generic():
    # Check type specification
    assert (
        primitives.Generic.to_flyte_literal_type().simple
        == literal_types.SimpleType.STRUCT
    )
