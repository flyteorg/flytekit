...
from flytekit.common import notifications as _notifications, schedules as _schedules, launch_plan as _launch_plan
...
def test_notifications():
    ...
    lp = workflow_to_test.create_launch_plan(
        notifications=[
            _notifications.PagerDuty([_execution.WorkflowExecutionPhase.FAILED], ['me@myplace.com'])
        ]
    )
