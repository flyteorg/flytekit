pub mod Auth {
    ...
    impl OAuthClient {
        pub fn new(endpoint: &str, insecure: &bool) -> OAuthClient {
            ...
            let public_cfg_res: flyteidl::flyteidl::service::PublicClientAuthConfigResponse =
            ...
            let client = BasicClient::new(
                ...
                // It may varied in different IdP, better to use `default` if not specify by OAuth2metadata.
            ...
            // We don't need refresh token at present clident side context.
            // .set_revocation_uri(
            //     RevocationUrl::new(
            //         todo!()
            //     )
