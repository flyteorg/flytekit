...
impl FlyteClient {
    ...
    pub fn new() -> PyResult<FlyteClient> {
        ...
        let channel = rt
            .block_on(Endpoint::from_static("http://localhost:30080").connect())
            .unwrap();
    ...
    pub fn create_task(&mut self, py: Python, bytes_obj: &PyBytes) -> PyResult<PyObject> {
        ...
        let res = (self.runtime.block_on(self.admin_service.create_task(req)))
            .unwrap()
            .into_inner();
    ...
    pub fn get_task(&mut self, py: Python, bytes_obj: &PyBytes) -> PyResult<PyObject> {
        ...
        // Interacting with the gRPC server: flyteadmin
        let res = (self.runtime.block_on(self.admin_service.get_task(req)))
            .unwrap()
            .into_inner();
    ...
    pub fn list_task_ids_paginated(
        ...
        let res = self
            .runtime
            .block_on(self.admin_service.list_task_ids(req))
            .unwrap()
            .into_inner();
    ...
    pub fn list_tasks_paginated(&mut self, py: Python, bytes_obj: &PyBytes) -> PyResult<PyObject> {
        ...
        let res = self
            .runtime
            .block_on(self.admin_service.list_tasks(req))
            .unwrap()
            .into_inner();
    ...
    pub fn get_workflow(&mut self, py: Python, bytes_obj: &PyBytes) -> PyResult<PyObject> {
        ...
        // Interacting with the gRPC server: flyteadmin
        let res = (self.runtime.block_on(self.admin_service.get_workflow(req)))
            .unwrap()
            .into_inner();
    ...
    pub fn list_workflow_ids_paginated(
        &mut self,
        py: Python,
        bytes_obj: &PyBytes,
    ) -> PyResult<PyObject> {
