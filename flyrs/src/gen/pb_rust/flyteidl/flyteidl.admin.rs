...
pub struct SignalListRequest {
    ...
    /// +required
    #[prost(message, optional, tag = "1")]
    pub workflow_execution_id: ::core::option::Option<
...
impl MatchableResource {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            MatchableResource::QualityOfServiceSpecification => {
    ...
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            ...
            "QUALITY_OF_SERVICE_SPECIFICATION" => {
                Some(Self::QualityOfServiceSpecification)
            }
...
pub struct ExecutionMetadata {
    ...
    #[prost(message, optional, tag = "5")]
    pub parent_node_execution: ::core::option::Option<
...
pub struct ExecutionSpec {
    ...
    pub notification_overrides: ::core::option::Option<
        execution_spec::NotificationOverrides,
    >,
}
