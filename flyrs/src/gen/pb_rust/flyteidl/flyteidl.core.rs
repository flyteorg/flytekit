...
pub struct TypeStructure {
    ...
    pub dataclass_type: ::std::collections::HashMap<
...
pub struct GpuAccelerator {
    ...
    pub partition_size_value: ::core::option::Option<
        gpu_accelerator::PartitionSizeValue,
    >,
}
...
pub struct TaskMetadata {
    ...
    pub cache_ignore_input_vars: ::prost::alloc::vec::Vec<
        ::prost::alloc::string::String,
    >,
...
pub struct ConjunctionExpression {
    ...
    pub left_expression: ::core::option::Option<
        ::prost::alloc::boxed::Box<BooleanExpression>,
    >,
    #[prost(message, optional, boxed, tag = "3")]
    pub right_expression: ::core::option::Option<
        ::prost::alloc::boxed::Box<BooleanExpression>,
    >,
}
...
pub struct NodeMetadata {
    ...
    pub cache_serializable_value: ::core::option::Option<
        node_metadata::CacheSerializableValue,
    >,
}
    ...
    impl OnFailurePolicy {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                ...
                OnFailurePolicy::FailAfterExecutableNodesComplete => {
        ...
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                ...
                "FAIL_AFTER_EXECUTABLE_NODES_COMPLETE" => {
                    Some(Self::FailAfterExecutableNodesComplete)
                }
                _ => None,
            }
        }
...
pub struct ConnectionSet {
    ...
    pub downstream: ::std::collections::HashMap<
        ::prost::alloc::string::String,
        connection_set::IdList,
    >,
    /// A list of all the node ids, that are upstream of this node id
    #[prost(map = "string, message", tag = "8")]
    pub upstream: ::std::collections::HashMap<
        ::prost::alloc::string::String,
        connection_set::IdList,
    >,
}
