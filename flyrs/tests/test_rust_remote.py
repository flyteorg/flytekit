...
def test_fetch_task_without_grpc():
    ...
    task_rs = remote_rs.fetch_task(project=PROJECT, domain=DOMAIN, name=TASK_NAME, version=VERSION_ID)
    ...
    task_py = remote_py.fetch_task(project=PROJECT, domain=DOMAIN, name=TASK_NAME, version=VERSION_ID)
