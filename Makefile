...
.PHONY: unit_test_tensorflow_codecov
unit_test_tensorflow_codecov:
	$(MAKE) CODECOV_OPTS="--cov=./ --cov-report=xml --cov-append" unit_test_tensorflow
