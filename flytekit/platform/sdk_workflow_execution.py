...
import flytekit.platform.sdk_node_execution
from platform.clients import iterate_node_executions as _iterate_node_executions
...
from flytekit.models import execution as _execution_models, literals as _literal_models
...
class SdkWorkflowExecution(
    ...
    def get_node_executions(self, filters=None):
        ...
        return {k: flytekit.platform.sdk_node_execution.SdkNodeExecution.promote_from_model(v) for k, v in _six.iteritems(node_exec_models)}
