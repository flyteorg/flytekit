...
CONFIGURATION_PATH = _common_config.FlyteStringConfigurationEntry('internal', 'configuration_path',
                                                                  default='flytekit.config')
...
def look_up_version_from_image_tag(tag):
    ...
    raise Exception('Could not parse image version from configuration. Did you set it in the'
                    'Dockerfile?')
