...
class FlytekitPlugin:
    ...
    def generate_execution_console_url(
        ...
        """Generate console url for a given execution."""
        return f"{console_http_domain}/console/projects/{entity.id.project}/domains/{entity.id.domain}/executions/{entity.id.name}"  # noqa
