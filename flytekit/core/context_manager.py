...
class ExecutionParameters(object):
    ...
    * a working directory for the user to write arbitrary files to
    ...
    class Builder(object):
        ...
        execution_id: typing.Optional[identifier_pb2.WorkflowExecutionIdentifier] = None
        ...
        task_id: typing.Optional[identifier_pb2.Identifier] = None
    ...
    def __init__(
        ...
        tmp_dir,
        stats,
        execution_id: typing.Optional[identifier_pb2.WorkflowExecutionIdentifier],
        logging,
        raw_output_prefix,
        checkpoint=None,
        decks=None,
    ...
    @property
    def execution_id(self) -> identifier_pb2.WorkflowExecutionIdentifier:
        """
    ...
    @property
    def task_id(self) -> typing.Optional[identifier_pb2.Identifier]:
        """
...
class FlyteContextManager(object):
    ...
    def initialize():
        ...
        default_execution_id = identifier_pb2.WorkflowExecutionIdentifier(project="local", domain="local", name="local")
        ...
        default_user_space_params = ExecutionParameters(
            ...
            task_id=identifier_pb2.Identifier(
                resource_type=identifier_pb2.TASK, project="local", domain="local", name="local", version="local"
            ),
