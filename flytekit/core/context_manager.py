...
import flytekit.core
from flytekit.clients import friendly as friendly_client  # noqa
from flytekit.configuration import images, internal, secrets
...
class ExecutionParameters(object):
    ...
    * a working directory for the user to write arbitrary files to
    ...
    class Builder(object):
        ...
        working_dir: typing.Union[os.PathLike, flytekit.core.utils.AutoDeletingTempDir]
        ...
        def build(self) -> ExecutionParameters:
            if not isinstance(self.working_dir, flytekit.core.utils.AutoDeletingTempDir):
    ...
    @property
    def working_directory(self) -> flytekit.core.utils.AutoDeletingTempDir:
        """
