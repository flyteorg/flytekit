...
class Promise(object):
    ...
    def __rshift__(self, other: typing.Union[Promise, VoidPromise]):
        if self.is_ready and other.ref:
...
def create_native_named_tuple(
    ctx: FlyteContext, promises: Union[Tuple[Promise], Promise, VoidPromise, None], entity_interface: Interface
) -> Optional[Tuple]:
    """
...
def flyte_entity_call_handler(
    entity: Union[SupportsNodeCreation], *args, **kwargs
