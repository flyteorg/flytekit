...
class TypeEngine(typing.Generic[T]):
    ...
    def register(
        ...
        for t in types:
            ...
            if restricted:
                cls._RESTRICTED_TYPES.append(t)
...
def _register_default_type_transformers():
    ...
    TypeEngine.register(RestrictedType("non typed tuple", tuple), restricted=True)
    TypeEngine.register(RestrictedType("non typed tuple", typing.Tuple), restricted=True)
    TypeEngine.register(RestrictedType("named tuple", NamedTuple), restricted=True)
