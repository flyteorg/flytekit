...
class ContainerTask(PythonTask):
    ...
    class MetadataFormat(Enum):
        JSON = task_models.DataLoadingConfig.LITERALMAP_FORMAT_JSON
        YAML = task_models.DataLoadingConfig.LITERALMAP_FORMAT_YAML
        PROTO = task_models.DataLoadingConfig.LITERALMAP_FORMAT_PROTO

    class IOStrategy(Enum):
        DOWNLOAD_EAGER = task_models.IOStrategy.DOWNLOAD_MODE_EAGER
        DOWNLOAD_STREAM = task_models.IOStrategy.DOWNLOAD_MODE_STREAM
        DO_NOT_DOWNLOAD = task_models.IOStrategy.DOWNLOAD_MODE_NO_DOWNLOAD
        UPLOAD_EAGER = task_models.IOStrategy.UPLOAD_MODE_EAGER
        UPLOAD_ON_EXIT = task_models.IOStrategy.UPLOAD_MODE_ON_EXIT
        DO_NOT_UPLOAD = task_models.IOStrategy.UPLOAD_MODE_NO_UPLOAD
    ...
    def get_container(self, settings: SerializationSettings) -> task_models.Container:
        ...
        return _get_container_definition(
            ...
            command=self._cmd,
            args=self._args,
            data_loading_config=task_models.DataLoadingConfig(
