...
class Resources(object):
    ...
    storage: Optional[Union[str, int]] = None
    ...
    def __post_init__(self):
        ...
        _check_none_or_str_or_int(self.storage)
...
def _convert_resources_to_resource_entries(resources: Resources) -> List[_ResourceEntry]:  # type: ignore
    ...
    if resources.storage is not None:
        resource_entries.append(_ResourceEntry(name=_ResourceName.STORAGE, value=str(resources.storage)))
