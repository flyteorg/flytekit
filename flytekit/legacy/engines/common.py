...
class BaseWorkflowExecution(object, metaclass=_common_models.FlyteABCMeta):
    ...
    def __init__(self, sdk_wf_exec):
        """
        :param flytekit.platform.sdk_workflow_execution.SdkWorkflowExecution sdk_wf_exec:
        """
    ...
    def get_node_executions(self, filters=None):
        ...
        :rtype: dict[Text, flytekit.platform.sdk_node_execution.SdkNodeExecution]
        """
        pass
...
class BaseNodeExecution(object, metaclass=_common_models.FlyteABCMeta):
    def __init__(self, node_execution):
        """
        :param flytekit.platform.sdk_node_execution.SdkNodeExecution node_execution:
        """
    ...
    def sdk_node_execution(self):
        """
        :rtype: flytekit.platform.sdk_node_execution.SdkNodeExecution
        """
...
class BaseTaskExecutor(object, metaclass=_common_models.FlyteABCMeta):
    ...
    def sdk_task(self):
        """
        :rtype: flytekit.legacy.runnables.SdkRunnableTask
        """
...
class BaseExecutionEngineFactory(object, metaclass=_common_models.FlyteABCMeta):
    ...
    def get_node_execution(self, node_exec):
        """
        :param flytekit.platform.sdk_node_execution.SdkNodeExecution node_exec:
    ...
    def get_workflow_execution(self, wf_exec):
        """
        :param flytekit.platform.sdk_workflow_execution.SdkWorkflowExecution wf_exec:
