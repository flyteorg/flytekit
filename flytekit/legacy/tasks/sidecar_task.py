...
from flytekit.old_plugins import k8s as _lazy_k8s


class SdkSidecarTask(flytekit.legacy.runnables.SdkRunnableTask, metaclass=_sdk_bases.ExtendedSdkType):
    ...
    def __init__(
        ...
        """
        :param flytekit.legacy.runnables.SdkRunnableTask sdk_runnable_task:
