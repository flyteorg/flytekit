...
class FlyteRemote(object):
    ...
    def fetch_task_lazy(self, project: str = None, domain: str = None, name: str = None,
                        version: str = None) -> LazyEntity:
        """
    ...
    def fetch_workflow_lazy(self, project: str = None, domain: str = None, name: str = None,
                            version: str = None) -> LazyEntity[FlyteWorkflow]:
        """
