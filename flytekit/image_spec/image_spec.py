...
class ImageSpec:
    ...
    Args:
        ...
        post_process_tag: Callable to post progress the tag generated by the image spec hash.
          The callable accepts the (image_spec, hash_tag) and must return a post processed tag for the image
    """
    ...
    post_process_tag: Optional[callable] = None
    ...
    def _image_name(self) -> str:
        ...
        if self.post_process_tag:
            tag = self.post_process_tag(self, tag)
