...
class SchemaType(type_models.SchemaType, metaclass=_sdk_bases.ExtendedSdkType):
    _LITERAL_TYPE_TO_PROTO_ENUM = {
        _primitives.Integer.to_flyte_literal_type(): type_models.SchemaType.SchemaColumn.SchemaColumnType.INTEGER,
        _primitives.Float.to_flyte_literal_type(): type_models.SchemaType.SchemaColumn.SchemaColumnType.FLOAT,
        _primitives.Boolean.to_flyte_literal_type(): type_models.SchemaType.SchemaColumn.SchemaColumnType.BOOLEAN,
        _primitives.Datetime.to_flyte_literal_type(): type_models.SchemaType.SchemaColumn.SchemaColumnType.DATETIME,
        _primitives.Timedelta.to_flyte_literal_type(): type_models.SchemaType.SchemaColumn.SchemaColumnType.DURATION,
        _primitives.String.to_flyte_literal_type(): type_models.SchemaType.SchemaColumn.SchemaColumnType.STRING,
    }
    ...
    def columns(self):
        ...
        """
        return [
            type_models.SchemaType.SchemaColumn(n, type(self)._LITERAL_TYPE_TO_PROTO_ENUM[v.to_flyte_literal_type()])
    ...
    def promote_from_model(cls, model):
        ...
        _PROTO_ENUM_TO_SDK_TYPE = {
            type_models.SchemaType.SchemaColumn.SchemaColumnType.INTEGER: _helpers.get_sdk_type_from_literal_type(
                _primitives.Integer.to_flyte_literal_type()
            ),
            type_models.SchemaType.SchemaColumn.SchemaColumnType.FLOAT: _helpers.get_sdk_type_from_literal_type(
                _primitives.Float.to_flyte_literal_type()
            ),
            type_models.SchemaType.SchemaColumn.SchemaColumnType.BOOLEAN: _helpers.get_sdk_type_from_literal_type(
                _primitives.Boolean.to_flyte_literal_type()
            ),
            type_models.SchemaType.SchemaColumn.SchemaColumnType.DATETIME: _helpers.get_sdk_type_from_literal_type(
                _primitives.Datetime.to_flyte_literal_type()
            ),
            type_models.SchemaType.SchemaColumn.SchemaColumnType.DURATION: _helpers.get_sdk_type_from_literal_type(
                _primitives.Timedelta.to_flyte_literal_type()
            ),
            type_models.SchemaType.SchemaColumn.SchemaColumnType.STRING: _helpers.get_sdk_type_from_literal_type(
