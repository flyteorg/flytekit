...
class SdkSidecarTask(
    ...
    def reconcile_partial_pod_spec_and_task(self, pod_spec, primary_container_name):
        ...
        if not primary_exists:
            containers.extend(
                [
                    _lazy_k8s.io.api.core.v1.generated_pb2.Container(
        ...
        for container in containers:
            ...
            if container.name == primary_container_name:
                ...
                resource_requirements = (
                    _lazy_k8s.io.api.core.v1.generated_pb2.ResourceRequirements()
                )
                for resource in self._container.resources.limits:
                    resource_requirements.limits[
                        ...
                        _lazy_k8s.io.apimachinery.pkg.api.resource.generated_pb2.Quantity(
                ...
                container.env.extend(
                    [
                        _lazy_k8s.io.api.core.v1.generated_pb2.EnvVar(
                            name=key, value=val
                        )
