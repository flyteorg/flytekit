...
# Delete this comment - note that this task inherits the much simpler SdkTask instead of the SdkRunnableTask
# like the SdkHiveTask does because the task isn't runnable (i.e. the user container is never spun up
# for a Presto task).
