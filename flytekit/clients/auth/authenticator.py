...
class PKCEAuthenticator(Authenticator):
    ...
    def __init__(self, endpoint: str, cfg_store: ClientConfigStore, header_key: str = None):
        """
...
class CommandAuthenticator(Authenticator):
    ...
    def refresh_credentials(self):
        ...
        """
        if not self._cmd:
            raise AuthenticationError("No command specified in configuration for command authentication")
