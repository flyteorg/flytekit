...
sagemaker_training = _lazy_loader.lazy_load_module("sagemaker-training")  # type: _lazy_loader._LazyLoadModule
...
_lazy_loader.LazyLoadPlugin(
    "schema", ["numpy>=1.14.0,<2.0.0", "pandas>=0.22.0,<2.0.0", "pyarrow>=0.11.0,<1.0.0"], [numpy, pandas],
)

_lazy_loader.LazyLoadPlugin("hive_sensor", ["hmsclient>=0.0.1,<1.0.0"], [hmsclient])

_lazy_loader.LazyLoadPlugin("sagemaker-training", ["sagemaker-training>=3.6.2,<4.0.0"], [sagemaker_training])
