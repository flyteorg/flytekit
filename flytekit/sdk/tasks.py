...
def notebook_task(
    ...
    .. code-block:: python
        ...
        my_task = notebook_task("path/to/nb.ipynb", inputs={'a': Types.Integer}, outputs={'b': Types.Float})

    :param Text notebook_path: this is the relative or absolute path to the notebook that should be executed.

    :param dict[Text,flytekit.common.types.base_sdk_types.FlyteSdkType] inputs: Arbitrary dict for input
        name and type.

    :param dict[Text,flytekit.common.types.base_sdk_types.FlyteSdkType] inputs: Arbitrary dict for output
        name and type.
    ...
    :param cls: This can be used to override the task implementation with a user-defined extension. The class
        provided must be a subclass of flytekit.common.tasks.sdk_runnable.RunnableNotebookTask.  A user can use this to
        inject bespoke logic into the base Flyte programming model.

    :rtype: flytekit.common.tasks.sdk_runnable.SdkRunnableTask
    """
    return (cls or _sdk_runnable_tasks.RunnableNotebookTask)(
