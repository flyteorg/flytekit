...
from flytekit.clis.sdk_in_container.utils import project_option_dec, domain_option_dec
...
@click.pass_context
def launchplan(ctx: click.Context, project: str, domain: str, limit: int, active_only: bool, launchplan_name: str,
               version: str):
    """
    ...
    if active_only:
        ...
        lps, _ = remote.client.list_launch_plans_paginated(
            NamedEntityIdentifier(project, domain), limit=limit,
