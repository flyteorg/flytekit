...
from flytekit import Literal, FlyteContext, LiteralType
from flytekit.core.type_engine import TypeEngine, TypeTransformerFailedError, TypeTransformer
...
class IteratorTransformer(TypeTransformer[typing.Iterator]):
    ...
    def to_literal(self, ctx: FlyteContext, python_val: typing.Iterator[T], python_type: typing.Type[T],
