    ...
    async def async_to_literal(
        ...
        if should_upload:
            ...
            if remote_path is not None:
                remote_path = ctx.file_access.async_put_data(source_path, remote_path, is_multipart=False, **headers)
            else:
                remote_path = ctx.file_access.async_put_raw_data(source_path, **headers)
