...
8. Examples:
  - Example of a simple python task that allows adding some python side functionality only [flytekit-greatexpectations](./flytekit-greatexpectations/)
  ...
  - Example of SQL backend plugin. The actual query invocation is done by a backend plugin. [flytekit-snowflake](./flytekit-snowflake/)
