...
| OpenAI Batch API             | `bash pip install flytekitplugins-openai`             | Interact with OpenAI's ChatGPT and submit requests to OpenAI for asynchronous batch processing.                            | [![PyPI version fury.io](https://badge.fury.io/py/flytekitplugins-openai.svg)](https://pypi.python.org/pypi/flytekitplugins-openai/)                         | Flytekit-only |
