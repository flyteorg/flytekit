...
from flytekit.extend.backend.base_agent import AgentBase, AgentRegistry, convert_to_flyte_state, get_secret
...
def get_header() -> typing.Dict[str, str]:
    token = get_secret("FLYTE_DATABRICKS_ACCESS_TOKEN")
