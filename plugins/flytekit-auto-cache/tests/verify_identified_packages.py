...
def main():
    ...
    expected_constants = {'SOME_CONSTANT': '111', 'utils.THIRD_CONSTANT': '1010', 'DummyClass.some_attr': 'some_custom_attr', 'yaml.__version__': '6.0', 'mod.SOME_OTHER_CONSTANT': '222', 'MY_OTHER_CONSTANT': '999'}
