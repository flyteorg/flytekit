...
class KubeConfig:
    ...
    def load_kube_config(self) -> None:
        ...
        try:
            ...
            logger.info("Successfully loaded in-cluster configuration using the aipflyteagent service account.")
        except config.ConfigException:
            logger.warning("Failed to load in-cluster configuration.")
