...
def cleanup_resources(resources: client.V1ResourceRequirements):
    # Starting Oct 16 10:30am, We have noticed that for the fields that are not specified, there will be 0 or "0" filled in
    # this is helper function to filter those values out.
    def is_zero_like(value):
        return value is None or value == "0" or value == 0 or str(value).strip().lower() == "0" or str(value).strip().lower() == "0gb"
