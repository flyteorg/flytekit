...
class ExampleConfig:
    ...
    dictconfig_key: ExampleNestedConfig = field(default_factory=ExampleNestedConfig)
...
class ExampleConfigWithNonAnnotatedSubtree:
    unnanotated_key = 1
    annotated_key: ExampleNestedConfig = field(default_factory=ExampleNestedConfig)
